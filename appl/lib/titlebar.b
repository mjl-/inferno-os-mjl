...
title_cfg := array[] of {
	...
	"bind .Wm_t <Button-2> {send wm_title max}",
	"bind .Wm_t <Button-3> {send wm_title full}",
	...
	"bind .Wm_t.title <Button-2> {send wm_title max}",
	"bind .Wm_t.title <Button-3> {send wm_title full}",
